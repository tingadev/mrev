           ...
           <div class="col-md-6">
               ...
               <form class="form-horizontal" method="POST" action="https://www.sandbox.PayPal.com/cgi-bin/webscr ">
                   <fieldset>
                       ...
                       <input type='hidden' name='cancel_return' value='<?php echo $payment->route("http://mrev.local:8888/payment_form.php", "") ?>'>
                       <input type='hidden' name='return' value='<?php echo $payment->route("http://mrev.local:8888/payment_form.php", "") ?>'>
