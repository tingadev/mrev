   ...
   if(isset($_POST['checkBoxArray'])){
      ...
      foreach($_POST['checkBoxArray'] as $postValueId)
      {
       ...
       if(isset($_POST['delete'])){
            global $connection;
            $query_menu="DELETE FROM payment_method where id={$postValueId}";
        ...
        if(isset($_POST['update'])){
            ...
            foreach ($_POST['displayArray'] as $key => $value) {
                if($key == $postValueId){
                    $query="UPDATE payment_method set display_order = {$value} where id={$key} ";
        ...
        if(isset($_POST['show'])){
            global $connection;
            $query="UPDATE payment_method set display = 1 where id={$postValueId} ";
            $update_display = mysqli_query($connection,$query);  
        }   
        if(isset($_POST['hide'])){
            global $connection;
            $query="UPDATE payment_method set display = 0 where id={$postValueId} ";
            $update_display = mysqli_query($connection,$query);
        }                       
        ...
        <div class="col-12">
            ...
            <form action="" method="post">
                <div class="col-xs-6">
                        ...
                        <a href="modules/payment/payment.php?act=add" class="btn btn-primary">Add New</a>
                </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                            ...
                            $query = "SELECT * from payment_method where lang = '".$lang."'";
                            ...
                            while($row = mysqli_fetch_assoc($select)){
                                ...
                                <tr>
                                    ...
                                    <td><a href="modules/payment/payment.php?act=update&id=<?php echo $id; ?>"><?php echo $title; ?></a></td>
                                    ...
                                    <td class='td-actions text-right'>
                                        ...
                                        <button onclick="location.href='modules/payment/payment.php?act=update&id=<?php echo $id; ?>'" type='button' rel='tooltip' class='btn btn-success btn-link btn-icon btn-sm'>
    ...
    $(document).ready(function(){
        ...
        $(".delete_link").on('click',function(){
           ...
           var id =$(this).attr('rel'); 
            ...
            var delete_url = "modules/payment/payment.php?delete="+ id +"";
