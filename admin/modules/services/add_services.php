...
if(isset($_POST['addServices'])){
    ...
    //services
    $res=insert('services',$data,'addServices');
    ...
    $select_lang = mysqli_query($connection,$query);
      while($row_l = mysqli_fetch_assoc($select_lang)){
        ...
        $res_desc=insert('services_desc',$_POST,'addServices'); 
        $res_seo=insert('seo_url',$seo_url,'addServices'); 
...
?>
  ...
  <div class="card-body">
    ...
    <form action='' method="post" enctype="multipart/form-data" target="_self">
      ...
      <input type="submit" name="addServices" class="btn btn-primary" value="Submit">
    </form>
  </div>
</div>
    </div>
