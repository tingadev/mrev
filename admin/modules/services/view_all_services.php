   ...
   if(isset($_POST['checkBoxArray'])){
      ...
      foreach($_POST['checkBoxArray'] as $postValueId)
      {
       ...
       if(isset($_POST['delete'])){
            global $connection;
            $query_menu="DELETE FROM services where id={$postValueId}";
            $delete_menu = mysqli_query($connection,$query_menu);
            $query_menu_desc="DELETE FROM services_desc where aid={$postValueId}";
        ...
        if(isset($_POST['update'])){
            ...
            foreach ($_POST['displayArray'] as $key => $value) {
                if($key == $postValueId){
                    $query="UPDATE services set op_order = {$value} where id={$key} ";
        ...
        <div class="col-12">
            ...
            <form action="" method="post">
                <div class="col-xs-6">
                        ...
                        <a href="modules/services/services.php?act=add" class="btn btn-primary">Add New</a>
                </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                            ...
                            $query = "SELECT a.id, a.display, ad.title,ad.link,ad.thumb from services a, services_desc ad where a.id = ad.aid and lang = '".$lang."'";
                            ...
                            while($row = mysqli_fetch_assoc($select)){
                                ...
                                <tr>
                                    ...
                                    <td><a href="modules/services/services.php?act=update&id=<?php echo $id; ?>"><?php echo $title; ?></a></td>
                                    <td><?php echo "<img style='max-height:70px;' src='../uploads/services/{$thumb}'>"; ?></td>
                                    <td><?php echo $link; ?></td>
                                    ...
                                    <td class='td-actions text-right'>
                                        ...
                                        <button onclick="location.href='modules/services/services.php?act=update&id=<?php echo $id; ?>'" type='button' rel='tooltip' class='btn btn-success btn-link btn-icon btn-sm'>
          ...
          if($_SESSION['role'] == 'admin')
              {
                ...
                $query_menu_desc="DELETE FROM services_desc where aid=$delete_id";
                $delete_menu_desc = mysqli_query($connection,$query_menu_desc);
    ...
    $(document).ready(function(){
        ...
        $(".delete_link").on('click',function(){
           ...
           var id =$(this).attr('rel'); 
            ...
            var delete_url = "modules/services/services.php?delete="+ id +"";
