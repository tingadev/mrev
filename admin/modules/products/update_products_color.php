...
if(isset($_GET['id'])){
  $edit_id = $_GET['id'];
  global $connection;
  $query = "SELECT * from color_table where id = $edit_id";
    ...
    <div class="card-body">
      ...
      <form action='' method="post" enctype="multipart/form-data" target="_self">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" name="code" id="code" placeholder="" value="<?php echo $item['code']; ?>">
        </div>      
...
if(isset($_POST['editOptions'])){
    ...
    $result = update('color_table',$data_desc,"id",$edit_id); 
